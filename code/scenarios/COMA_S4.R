# COMA con la candidate pool formada por el crossing block del ano anterior mas S4: solo clones con fenotipo
# replicado y los padres ya en uso. Es el control opuesto a COMA_onlyS2.
